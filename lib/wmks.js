(function() {
    ...
    g.CHUNK_COMMON_HEADER_SIZE = 4, g.CHUNK_LARGE_HEADER_SIZE = 4, g.CHUNK_EXTENSION_HEADER_SIZE = 4, g.CHUNK_MAX_LEN = 65536, g.CHUNK_LARGE_MAX_LEN = 4294966272, g.SESSION_STATE = {
        ...
        }, a.readyState && a.onopen({}), !0) : (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession.attachToWebSocket", "Invalied socket, must be instanceof WebSocket"), !1)
