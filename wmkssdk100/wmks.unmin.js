(function()
{
    ...
    function d(a)
    {
        ...
        var b = a,
            ...
            g = function(a)
            {
                a.onload = a.onerror = null, a.src = "data:image/jpeg;base64," + c.encodeFromString("" + $.now()), d.length <= b ? d.push(a) : f([a])
            };
    ...
    function e()
    {
        this._mediaSource = null, this._sourceBuffer = null, this._tempQueue = [], this._mediaPlayer = null, e.instanceNumber++, this._name = "MP4Decoder" + e.instanceNumber
    }
    ...
    function f(d)
    {
        ...
        }, f._readTightData = function(a)
        {
            ...
            a.image = this._imageManager.getImage(), a.image.width = a.width, a.image.height = a.height, a.image.destX = a.x, a.image.destY = a.y, a.subEncoding !== this.subEncPNG && (this._lastJpegData = e), f ? (e = b(e, !0), a.image.onload = this.onDecodeObjectURLComplete, a.image.src = f.createObjectURL(new Blob([e],
            {
                type: d
    ...
    WMKS = {}, WMKS.LOGGER = new function()
        {
            ...
            {
                d = d === undefined ? this.LEVEL.INFO : d, d >= a && c && console.log((WMKS.BROWSER.isIE() ? (new Date)
        ...
        }, WMKS.BROWSER = new function()
        {
            ...
            {
                var b = {};
                return a && (b.position = "absolute"), $("<canvas/>")
                    .css(b)
            },
            createVideo: function(a)
            {
                var b = {};
                return a && (b.position = "absolute"), $("<video/>")
                    .css(b)
            },
        ...
        {
            var d = this,
                e = b || window.URL || window.webkitURL,
                f = c || window.MediaSource || window.WebKitMediaSource;
            this.reset(), this._mediaPlayer = a, this._mediaSource = new f, this._mediaPlayer.src = e.createObjectURL(this._mediaSource), this._mediaSource.addEventListener("sourceopen", function(a)
            {
                return d._onMediaSourceOpen(a)
        ...
        {
            var b = this;
            WMKS.LOGGER.log(this + " media source status is changed to open."), this._sourceBuffer = this._mediaSource.addSourceBuffer(e.byteStreamFormat), this._sourceBuffer.addEventListener("update", function()
            {
                b._flushPayloads()
            }), this._flushPayloads();
            return
        }, e.prototype._flushPayloads = function()
        {
            ...
            while (this._tempQueue.length > 0 && !this._sourceBuffer.updating) this._sourceBuffer.appendBuffer(this._tempQueue.shift())
        }, e.prototype.reset = function()
        {
            WMKS.LOGGER.log(this + " is reset."), this._mediaSource && (this._sourceBuffer && (this._mediaSource.removeSourceBuffer(this._sourceBuffer), this._sourceBuffer = null), this._mediaSource.readyState === "open" && this._mediaSource.endOfStream(), this._mediaSource = null), this._mediaPlayer && (this._mediaPlayer.src = "", this._mediaPlayer = null), this._tempQueue = []
        }, e.prototype.appendData = function(a)
        {
            this._sourceBuffer !== null && this._mediaSource.readyState === "open" && !this._sourceBuffer.updating ? this._sourceBuffer.appendBuffer(a) : this._tempQueue.push(a), this._mediaPlayer && this._mediaPlayer.paused && this._mediaPlayer.play()
        },
        function()
        {
            function d(a)
        ...
        }(), WMKS.VNCDecoder = function(a)
        {
            ...
            }), this.setRenderCanvas(this.options.canvas), this.options.backCanvas && (this._canvas = this._canvas.concat([this.options.backCanvas]), this._canvas[1].ctx = this.options.backCanvas.getContext("2d")), this.options.blitTempCanvas && (this._canvas = this._canvas.concat([this.options.blitTempCanvas]), this._canvas[2].ctx = this.options.blitTempCanvas.getContext("2d")), this._imageManager = new d(256), this.options.mediaPlayer && (this._mp4Decoder = new e), this._releaseImage = function(a)
            {
                a.destX = a.destY = null, this._imageManager.releaseImage(a)
            }, this
        ...
        }, WMKS.VNCDecoder.prototype._readTightData = function(a)
        {
            var b = this._readBytes(this.nextBytes),
                ...
                e;
            a.image = this._imageManager.getImage(), a.image.width = a.width, a.image.height = a.height, a.image.destX = a.x, a.image.destY = a.y, a.subEncoding === this.subEncDiffJpeg && (b = this._decodeDiffComp(b, this._lastJpegData)), a.subEncoding !== this.subEncPNG ? (this._lastJpegData = b, e = "image/jpeg") : e = "image/png", d ? (a.image.onload = this.onDecodeObjectURLComplete, a.image.src = d.createObjectURL(new Blob([b],
            {
                type: e
            }))) : (b = c.encodeFromArray(b), a.image.onload = this.onDecodeComplete, a.image.src = "data:" + e + ";base64," + b), this._nextRect()
        }, WMKS.VNCDecoder.prototype._readTightPNG = function(a)
        {
            a.subEncoding = this._readByte(), a.subEncoding &= this.subEncMask, this._mediaPlayer && (this.options.onEncodingChanged("PNG"), this.options.mediaPlayer = null, this._mediaPlayer = null);
            ...
            else
            {
                var b = 1,
                    c = this._readByte();
                c & 128 && (b = 2, c &= -129, c += this._readByte() << 7, c & 16384 && (b = 3, c &= -16385, c += this._readByte() << 14)), this._setReadCB(c, this._readTightData, a)
            }
        }, WMKS.VNCDecoder.prototype._readH264MP4Rect = function(a)
        {
            var b = this._readInt16(),
                c = this._readInt16(),
                d = this._readInt32();
            b === 1 && (WMKS.LOGGER.log("MP4 encoding is selected and stream is reset."), this._mp4Decoder.init(this._mediaPlayer)), this._setReadCB(d, this._readH264MP4Data, a)
        ...
        }, WMKS.VNCDecoder.prototype._readRect = function()
        {
            ...
            this.rect[a] = {}, this.rect[a].x = this._readInt16(), this.rect[a].y = this._readInt16(), this.rect[a].width = this._readInt16(), this.rect[a].height = this._readInt16(), this.rect[a].encoding = this._readInt32(), this.rect[a].encoding !== this.encTightPNG && this.rectsDecoded++;
        ...
        }, WMKS.VNCDecoder.prototype._executeRectSingle = function(a)
        {
            ...
            switch (a.encoding)
            {
                ...
                case this.encOffscreenCopyRect:
                    ...
                    break;
                case this.encTightPNG:
                    a.subEncoding === this.subEncFill ? this._fillRectWithColor(b, a.x, a.y, a.width, a.height, a.color) : this.decodeToCacheEntry === -1 ? (b.drawImage(a.image, a.image.destX, a.image.destY), this._releaseImage(a.image), a.image = null) : (this.updateCache[this.decodeToCacheEntry].image = a.image, a.image = null);
                    break;
                case this.encDesktopSize:
                case this.encVMWDefineCursor:
                case this.encVMWCursorState:
        ...
        {
            a.data = this._readBytes(a.length), this.useVMWAudioAck && (a.flags == 0 || a.flags & this.audioflagRequestAck) && this._sendAudioAck(a.audioTimestampLo, a.audioTimestampHi), this.options.onAudio(a), this._getNextServerMessage()
        ...
        }, WMKS.VNCDecoder.prototype.setRenderCanvas = function(a)
        {
            ...
            ControlKeys: [8, 9, 13, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45, 46, 91, 92, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 144, 145],
            ...
            VScanMap:
            {}
        }, WMKS.CONST.KB.ANSISpecialSymbols = WMKS.CONST.KB.ANSIShiftSymbols + WMKS.CONST.KB.ANSINoShiftSymbols, WMKS.KeyboardManager = function(a)
        {
            "use strict";
            if (!a || !a.vncDecoder) return null;
            this._vncDecoder = a.vncDecoder, this.ignoredRawKeyCodes = a.ignoredRawKeyCodes, this.fixANSIEquivalentKeys = a.fixANSIEquivalentKeys, this.mapMetaToCtrlForKeys = a.mapMetaToCtrlForKeys, this.keyDownKeyTimer = null, this.keyDownIdentifier = null, this.pendingKey = null, this.activeModifiers = [], this.keyToUnicodeMap = {}, this.keyToRawMap = {}, this.UnicodeToVScanMap = WMKS.CONST.KB.VScanMap[a.keyboardLayoutId], this._windowsKeyManager = {
                ...
                {
                    a.keyCode === WMKS.CONST.KB.WindowsKeys.left ? (this.leftWindowsDown = a.type === "keydown", this.leftWindowsDown || (this.windowsOn = !1)) : a.keyCode === WMKS.CONST.KB.WindowsKeys.right && (this.rightWindowsDown = a.type === "keydown", this.rightWindowsDown || (this.windowsOn = !1))
                },
            ...
            }, this._extractKeyCodeFromEvent = function(a)
            {
                ...
                else if (a.keyCode === 0 && WMKS.BROWSER.isFirefox() && a.key) b = 0;
                else if (this.UnicodeToVScanMap === WMKS.CONST.KB.VScanMap["ja-JP_106/109"] && !WMKS.BROWSER.isFirefox() && a.keyCode === 0) b = 165;
                else return WMKS.LOGGER.trace("assert: could not read keycode from event, keyIdentifier=" + a.keyIdentifier), null;
            ...
            }, this.onKeyDown = function(a)
            {
                var b, c = 0,
                    d = !1,
                    e = this;
                return b = this._extractKeyCodeFromEvent(a), b ? (c = b.keyCode, d = b.isUnicode, this._syncModifiers(a), c === 0 ? (WMKS.LOGGER.log("onKeyDown: Do not send 0 to server."), !0) : $.inArray(c, WMKS.CONST.KB.Modifiers) !== -1 ? (a.returnValue = !1, !1) : WMKS.CONST.KB.ControlKeys.indexOf(c) !== -1 ? (a.returnValue = !1, this._handleControlKeys(c)) : d ? (WMKS.LOGGER.log("Send unicode down from keyIdentifier: " + c), e.sendKey(c, !1, !0), a.returnValue = !1, !1) : (this.keyDownKeyTimer !== null && (WMKS.LOGGER.log("assert: nuking an existing keyDownKeyTimer"), clearTimeout(this.keyDownKeyTimer)), this.keyDownKeyTimer = setTimeout(function()
                {
                    e.sendKey(c, !1, !1), e.keyDownKeyTimer = null, e.pendingKey = null
                }, 0), this.pendingKey = c, a.originalEvent && a.originalEvent.keyIdentifier && (this.keyDownIdentifier = a.originalEvent.keyIdentifier), a.returnValue = this.activeModifiers.length !== 1 || this.activeModifiers[0] !== WMKS.CONST.KB.KEY_CODE.Alt && this.activeModifiers[0] !== WMKS.CONST.KB.KEY_CODE.Ctrl && this.activeModifiers[0] !== WMKS.CONST.KB.WindowsKeys.left && this.activeModifiers[0] !== WMKS.CONST.KB.WindowsKeys.right, a.returnValue)) : (WMKS.LOGGER.log("Extraction of keyCode from keyUp event failed."), !1)
            }, this._handleControlKeys = function(a)
            {
                if (a === WMKS.CONST.KB.KEY_CODE.CapsLock && WMKS.BROWSER.isMacOS())
                {
            ...
            {
                var b, c, d, e, f = [a.shiftKey, a.ctrlKey, a.altKey, a.metaKey, !1];
                a.altGraphKey === !0 && (f[1] = f[2] = !0), a.metaKey === !0 && this.mapMetaToCtrlForKeys.indexOf(a.keyCode) !== -1 && (f[1] = !0, f[3] = !1);
            ...
            }, this.onKeyPress = function(a)
            {
                ...
                else if (a.keyCode) b = a.keyCode, c = !0;
                ...
                this._syncModifiers(a), this.pendingKey !== null && (c ? this.keyToRawMap[this.pendingKey] = b : this.keyToUnicodeMap[this.pendingKey] = b);
                ...
                return this.keyDownIdentifier = null, this.fixANSIEquivalentKeys && h && g && (f || d || e) ? (e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !0, !1), this.handleSoftKb(h.charCodeAt(0), !0), e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !1, !1)) : this.sendKey(b, !1, !c), (this.pendingKey === 50 && b === 126 || this.pendingKey === 55 && b === 96) && !c && (WMKS.LOGGER.debug("Sending extra up for Unicode " + b + " so one isn't missed."), this.sendKey(b, !0, !c)), this.pendingKey = null, !1
            }, this.onKeyUp = function(a)
            {
                var b, c, d, e, f = !1;
                return a.preventDefault ? a.preventDefault() : a.returnValue = !1, this.keyDownIdentifier = null, c = this._extractKeyCodeFromEvent(a), c ? (b = c.keyCode, f = c.isUnicode, this._syncModifiers(a), b === 0 ? (WMKS.LOGGER.log("onKeyUp: Do not send 0 to server."), !0) : $.inArray(b, WMKS.CONST.KB.Modifiers) !== -1 ? !1 : (f ? (WMKS.LOGGER.log("Sending unicode key up from keyIdentifier: " + b), this.sendKey(b, !0, !0)) : this.keyToUnicodeMap.hasOwnProperty(b) ? (d = this.keyToUnicodeMap[b], this.sendKey(d, !0, !0), delete this.keyToUnicodeMap[b]) : this.keyToRawMap.hasOwnProperty(b) ? (e = this.keyToRawMap[b], this.sendKey(e, !0, !1), delete this.keyToRawMap[b]) : this.sendKey(b, !0, !1), !1)) : (WMKS.LOGGER.debug("Extraction of keyCode from keyUp event failed."), !1)
            ...
            {
                var b = a.keyCode || a.which;
                return WMKS.BROWSER.isAndroid() && WMKS.BROWSER.isChrome() ? !0 : ($(a.target)
                    .val(WMKS.CONST.KB.keyInputDefaultValue), this.handleSoftKb(b, !0), !0)
            }, this.onInputTextSoftKb = function(a)
            {
                var b = $(a.target),
                    c = b.val(),
                    d = WMKS.CONST.KB.keyInputDefaultValue.length;
                return WMKS.BROWSER.isIOS() ? (b.val(WMKS.CONST.KB.keyInputDefaultValue), !1) : (d > 0 && (c = c.substring(d)), c.length > 1 ? (c = c.charAt(0)
                    .toLowerCase() + c.slice(1), this.processInputString(c)) : WMKS.BROWSER.isAndroid() && WMKS.BROWSER.isChrome() && this.processInputString(c), b.val(WMKS.CONST.KB.keyInputDefaultValue), !0)
            ...
            }, this._sendVScanCode = function(a, b, c)
            {
                ...
                d || (d = WMKS.keyboardUtils._jsToVScanTable[a], d || (d = this.UnicodeToVScanMap[a])), d ? this._vncDecoder.onKeyVScan(d, !b) : WMKS.LOGGER.debug("unknown key: " + a + (b ? "-up" : "-d"))
        ...
        {}, WMKS.CONST.KB.UnicodeOnly, WMKS.CONST.KB.UnicodeWithShift), WMKS.keyboardUtils = {}, WMKS.keyboardUtils._keyInfoTemplate = {
            jsScanCode: 0,
            vScanCode: 0
        ...
        }, WMKS.TouchHandler = function(a)
        {
            ...
            {
                var b, c, d, e, f, g = !1;
                return WMKS.BROWSER.isTouchDevice() ? !a || a.is(":hidden") ? !1 : (b = a.width(), c = a.height(), e = window.innerWidth, f = window.innerHeight, WMKS.UTIL.TOUCH.isPortraitOrientation() ? a.offset()
                    .left + b > e && (a.offset(
                    {
                        left: String(e - b - 5)
                    }), g = !0) : a.offset()
            ...
            {
                var b = this;
                this._isInputInFocus() && $(window)
                    .one("resize", function(a)
                    {
                        setTimeout(function()
                        {
                            $(window)
                                .trigger("orientationchange"), b._repositionFloatingElementsOnRotation()
                        }, 500)
                    })
            ...
            {
                a ? (f.focus(), j.inputProxy.focus()
                    .select()) : (WMKS.BROWSER.isAndroid() && (j.inputProxy.attr("readonly", !0)
                    .attr("disabled", !0), setTimeout(function()
                    {
                        j.inputProxy.attr("readonly", !1)
                            .attr("disabled", !1), f.focus()
            ...
            }, this.installTouchHandlers = function()
            {
                ...
                f.css(
                    ...
                    .appendTo(b), j.clickFeedback = $("<div/>")
                    .addClass("feedback-container tap-icon")
                    .appendTo(b), j.dragFeedback = $("<div/>")
                    .addClass("feedback-container drag-icon")
                    .appendTo(b), j.pulseFeedback = $("<div/>")
                    .addClass("feedback-container pulse-icon")
                    .appendTo(b), j.scrollFeedback = $("<div/>")
                    .addClass("feedback-container scroll-icon")
                    .appendTo(b), b.find(".feedback-container")
                    .bind("touchmove.wmks", function(b)
                    {
                        return a._onTouchMove(b.originalEvent)
                    })
                    .bind("touchstart.wmks", function(b)
            ...
            {
                if (!f) return;
                f.unbind("orientationchange.wmks.icons")
                    .unbind("orientationchange.wmks")
                    .unbind("touchmove.wmks")
                    .unbind("touchstart.wmks")
                    .unbind("touchend.wmks"), f.find(".feedback-container")
                    .unbind("touchmove.wmks")
                    .unbind("touchstart.wmks")
        ...
        }, WMKS.widgetProto._setOption = function(a, b)
        {
            ...
            switch (a)
            {
                ...
                case "keyboardLayoutId":
                    this._keyboardManager.UnicodeToVScanMap = WMKS.CONST.KB.VScanMap[b];
                    break;
        ...
        }, WMKS.widgetProto.getCanvasPosition = function(a, b)
        {
            ...
            var e = Math.ceil((a - c.left) * d),
                f = Math.ceil((b - c.top) * d),
                g = Math.ceil(this._canvas.width()) - 1,
                h = Math.ceil(this._canvas.height()) - 1;
            return e = Math.min(e, g), f = Math.min(f, h), e = Math.max(e, 0), f = Math.max(f, 0),
            {
                x: e,
                y: f
            }
        ...
        }, WMKS.widgetProto._isCanvasMouseEvent = function(a)
        {
            ...
            return this._mouseDownBMask !== 0 ? !0 : c === this._canvas[0] || this._video && c === this._video[0]
        ...
        }, WMKS.widgetProto.connectEvents = function()
        {
            ...
            this.element.bind("blur.wmks", function(b)
                ...
                {
                    return a.updateUserActivity(), a._onMouseMove(b)
                })
                .bind("mousewheel.wmks", function(b)
                {
                    return a.updateUserActivity(), a._onMouseWheel(b)
                })
                .bind("mouseup.wmks", function(b)
                {
                    return a.updateUserActivity(), a._onMouseButton(b, 0)
                })
                .bind("mousedown.wmks", function(b)
                {
                    return a.updateUserActivity(), a._onMouseButton(b, 1)
                }), this._touchHandler && this._touchHandler.installTouchHandlers()
        ...
        {
            a = a ||
            {}, a.show = !1, this.toggleKeyboard(a)
        }, WMKS.widgetProto.showKeyboard = function(a)
        {
            a = a ||
            {}, a.show = !0, this.toggleKeyboard(a)
        ...
        {
            this.disconnect(), this.element.removeClass("wmks"), this._touchHandler.destroy(), this._touchHandler = null, this._canvas.remove(), this._video && this._video.remove(), this._backCanvas && this._backCanvas.remove(), this._blitTempCanvas && this._blitTempCanvas.remove(), $.Widget.prototype.destroy.call(this)
        ...
        }, WMKS.widgetProto._create = function()
        {
            ...
            this._mouseDownBMask = 0, this._mousePosGuest = {
                    x: 0,
                    y: 0
                }, this._scale = 1, this._pixelRatio = 1, this.connected = !1, this._canvas = WMKS.UTIL.createCanvas(!0)
                .prop(
                {
                    id: "mainCanvas",
                    tabindex: 1
            ...
            this.transform = b("transform") || b("WebkitTransform") || b("MozTransform") || b("msTransform") || b("OTransform"), this._vncDecoder = new WMKS.VNCDecoder(
            {
                ...
                {
                    b === "PNG" && a._video && (WMKS.LOGGER.info("Remove video element since we use PNG encoding."), a._video.remove(), a._video = null)
                },
        ...
        function()
        {
            ...
            {
                this.options = $.extend(
                {}, this.options, a), this.dialog = this.create(), this.init()
            },
        ...
        function()
        {
            ...
            WMKS.extendedKeypad.prototype.create = function()
            {
                ...
                return b.append(this.getControlPaneHtml()), b.dialog(
                {
                    ...
                    close: function(c)
                    {
                        return a._kbManager.cancelModifiers(!0), b.find(".ab-modifier-key.ab-modifier-key-down")
                            .removeClass("ab-modifier-key-down"), a.toggleFunctionKeys(!1), a.sendUpdatedState(!1), !0
                    },
                    dragStop: function(b)
                    {
            ...
            WMKS.extendedKeypad.prototype.init = function()
            {
                ...
                b.find(".ab-modifier-key")
                    .on("touchstart", function(b)
                    {
                        var c = $(this)
                            .hasClass("ab-modifier-key-down"),
                            d = parseInt($(this)
                                .attr("abkeycode"), 10);
                        return isNaN(d) ? (WMKS.LOGGER.debug("Got NaN as modifier key. Skipping it."), !1) : ($(this)
                            .toggleClass("ab-modifier-key-down"), a._kbManager.updateModifiers(d, c), !1)
                    }), b.find("#fnMasterKey")
                    .off("touchstart")
                    .on("touchstart", function(b)
                    {
                        return a.toggleFunctionKeys(), !1
                    }), b.find(".ab-extended-key")
                    .off("touchstart")
                    .on("touchstart", c), b.find(".ab-flip")
                    .off("touchstart")
                    .on("touchstart", function()
                    {
                        return $(this)
                            .parents(".flip-container")
                            .toggleClass("perform-flip"), a.toggleFunctionKeys(!1), !1
                    }), b.parent()
                    .prop("id", "ctrlPaneWidget"), b.parent()
                    .parent()
                    .append(this.getFunctionKeyHtml()), $("#fnKeyPad")
                    .find(".ab-extended-key")
                    .off("touchstart")
                    .on("touchstart", c), b.parent()
                    .off("orientationchange.ctrlpane")
            ...
            WMKS.dialogManager.prototype.disconnect = function()
            {
                var a = this.dialog;
                a.find("#fnMasterKey")
                    .off("touchstart"), a.find(".ab-extended-key")
                    .off("touchstart"), a.find(".ab-flip")
                    .off("touchstart"), a.parent()
                    .off("orientationchange.ctrlpane"), $("#fnKeyPad")
                    .find(".ab-extended-key")
                    .off("touchstart")
            },
            ...
            WMKS.extendedKeypad.prototype.toggleFunctionKeys = function(a)
            {
                ...
                b.toggle(c), $("#fnMasterKey")
                    .toggleClass("ab-modifier-key-down", c), this.positionFunctionKeys()
            },
            WMKS.extendedKeypad.prototype.positionFunctionKeys = function()
            {
                ...
                if (a.is(":visible"))
                {
                    ...
                    var e;
                    d ? (e = parseInt(b.css("z-index"), 10) - 1, $("#fnKeyInnerBorder")
                        .css("border-color", "#d5d5d5")) : (e = parseInt($("#ctrlPaneWidget")
                            .css("z-index"), 10) + 1, $("#fnKeyInnerBorder")
                        .css("border-color", "#aaa")), a.css("z-index", e.toString())
                }
                return !0
            },
        ...
        function()
        {
            ...
            WMKS.trackpadManager.prototype.init = function()
            {
                ...
                this._widget.requestElementReposition(a.parent(), !0), c = a.find("#trackpadSurface")
            ...
            WMKS.trackpadManager.prototype.disconnect = function()
            {
                var a = this.dialog,
                    b, c, d;
                if (!a) return;
                b = a.find("#trackpadSurface")
                    .off("touchmove")
                    .off("touchstart")
                    .off("touchend"), c = a.find("#trackpadLeft")
                    .off("touchstart")
                    .off("touchend"), d = a.find("#trackpadRight")
                    .off("touchstart")
                    .off("touchend")
            },
            ...
            {
                return b !== WMKS.CONST.CLICK.left && b !== WMKS.CONST.CLICK.right ? (WMKS.LOGGER.debug("assert: unknown button " + b), !1) : ($(a.target)
                    .addClass("button-highlight"), this._widget.sendMouseButtonMessage(this.getMousePosition(), !0, b), !1)
            },
            WMKS.trackpadManager.prototype.trackpadClickEnd = function(a, b)
            {
                return b !== WMKS.CONST.CLICK.left && b !== WMKS.CONST.CLICK.right ? (WMKS.LOGGER.debug("assert: unknown button " + b), !1) : ($(a.target)
                    .removeClass("button-highlight"), this._widget.sendMouseButtonMessage(this.getMousePosition(), !1, b), !1)
            },
            ...
            WMKS.trackpadManager.prototype.trackpadTouchMove = function(a)
            {
                var b, c, d, e = $(a.target),
                    f = this._widget;
                return this._dragTimer !== null && (clearTimeout(this._dragTimer), this._dragTimer = null), this.state === WMKS.CONST.TRACKPAD.STATE.idle ? !1 : (b = a.targetTouches[0].pageX, c = a.targetTouches[0].pageY, c < e.offset()
                    .top || c > e.offset()
            ...
            WMKS.trackpadManager.prototype.trackpadTouchEnd = function(a)
            {
                var b;
    ...
    g.MAJOR_VER = 1, g.MINOR_VER = 0, g.CAPS_V10_1 = 0, g.CAPS_V10_2 = 0, g.ALL_SESSIONS = -1, g.RTT_HISTORY_SIZE = 30, g.MIN_CHANNEL_NAME_LEN = 1, g.MAX_CHANNEL_NAME_LEN = 255, g.MAX_INITIAL_DATA_LEN = 4096, g.STATUS = {
        SUCCESS: 0,
        ERROR: 1,
        OUT_OF_MEMORY: 2,
        INVALID_ARGS: 3,
    ...
    {
        return this.id = b, this.name = c, this.priority = d || 0, this.flags = e || 0, this.timeout = f || 0, this.protocol = "binary", this.state = g.CHANNEL_STATE.INIT, this.onopen = null, this.onclose = null, this.onerror = null, this.onmessage = null, this._session = a, this._vvcInstance = a.vvcInstance, this
    };
    g.CHANNEL_STATE = {
        INIT: 0,
        OPEN_FAILED: 1,
    ...
    var j = function(a)
    {
        return this._rttSendTimeMS = 0, this.state = g.CHANNEL_STATE.OPEN, $.extend(a, this)
    };
    g.CTRL_HEADER_SIZE = 4, g.CONTROL_CHANNEL_ID = 0, g.CONTROL_CHANNEL_NAME = "vvcctrl", g.CTRL_OP = {
        RECV_ACK: 1,
        INIT: 2,
        INIT_ACK: 3,
        OPEN_CHAN: 4,
    ...
    {
        var b;
        return a === undefined && (a = g.CTRL_OP.INIT), a !== g.CTRL_OP.INIT && a !== g.CTRL_OP.INIT_ACK ? (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCControlChannel.sendInit", "Invalid code,  expected INIT or INIT_ACK"), !1) : (b = this._createControlPacket(a), b.writeUint16(g.MAJOR_VER), b.writeUint16(g.MINOR_VER), b.writeUint32(g.CAPS_V10_1), b.writeUint32(g.CAPS_V10_2), this._sendControlPacket(b))
    ...
    {
        var c, d, e, f;
        return this._checkErrorMinimumSize(b, a) ? this._checkErrorSessionState(b, g.SESSION_STATE.INIT) ? (c = a.readUint16(), d = a.readUint16(), e = a.readUint32(), f = a.readUint32(), b === g.CTRL_OP.INIT && this.sendInit(g.CTRL_OP.INIT_ACK), this._session.onConnect(), !0) : !1 : !1
    ...
    }, l.prototype.openChannel = function(a, b, c, d, e)
    {
        var f;
    ...
    }, l.prototype.acceptChannel = function(a, b, c)
    {
    ...
    }, l.prototype.rejectChannel = function(a, b)
    {
    ...
    }, l.prototype.closeChannel = function(a)
    {
    ...
    }, l.prototype.addRttTime = function(a)
    {
    ...
    }, l.prototype.attachToWebSocket = function(a)
    {
        var b = this;
        return a instanceof WebSocket ? (this.socket = a, a.onopen = function(a)
        {
        ...
        }, a.readyState && a.onopen(
        {}), !0) : (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession.attachToWebSocket", "Invalied socket, must be instanceof WebSocket"), !1)
    }, l.prototype._nextChannelId = function()
    {
        var a = this._channelIdCtrl;
        return this._channelIdCtrl += 2, a
    }, l.prototype.createChannel = function(a, b, c, d, e)
    {
        var f;
        return c = c || 0, e = e || 0, d = d || 0, f = new i(this, a, b, c, d, e), this._channels[a] = f, this._buffers.data[a] = [], f
    }, l.prototype._releaseChannel = function(a)
    {
    ...
    }, l.prototype.getChannel = function(a)
    {
        return this._channels[a] ? this._channels[a] : null
    }, l.prototype.onSessionError = function(a, b, c)
    {
        this.state = g.SESSION_STATE.ERROR, this._vvcInstance.setLastError(a, b, c), this.onerror && this.onerror(a)
    }, l.prototype.onSessionClose = function()
    {
        var a, b, c;
        this.state === g.SESSION_STATE.ERROR ? b = g.CLOSE_CHAN_REASON.ERROR : b = g.CLOSE_CHAN_REASON.NORMAL, this.state = g.SESSION_STATE.CLOSING, this.socket.close();
    ...
    }, l.prototype.onPeerOpen = function(a)
    {
        var b, c, d;
    ...
    }, l.prototype.onChannelOpen = function(a, b, c)
    {
    ...
    }, l.prototype.onChannelError = function(a)
    {
        a.onerror && a.onerror(this._createEvent("error"))
    }, l.prototype.onChannelMessage = function(a, b)
    {
        if (!a)
        {
    ...
    }, l.prototype.onChannelClose = function(a, b)
    {
        var c;
    ...
    }, l.prototype._onTransportOpen = function()
    {
        this.controlChannel = this.createChannel(g.CONTROL_CHANNEL_ID, g.CONTROL_CHANNEL_NAME), this.controlChannel = new j(this.controlChannel), this._server || this.controlChannel.sendInit(g.CTRL_OP.INIT)
    }, l.prototype._onTransportClose = function(a)
    {
    ...
    }, l.prototype._onTransportError = function(a)
    {
    ...
    }, l.prototype._combineBuffers = function(a)
    {
        var b, c, d, e;
        ...
        return c
    }, l.prototype._setReceiveState = function(a)
    {
    ...
    }, l.prototype._onTransportRecv = function(a)
    {
        var b, c, d, e;
        ...
        switch (this._receiveState)
        {
            ...
            case g.SESSION_RECEIVE_STATE.LARGE_HEADER:
                ...
                break;
            case g.SESSION_RECEIVE_STATE.EXTENSION_HEADER:
                this._chunk.ext.code = b.readUint8(), this._chunk.ext.flags = b.readUint8(), this._chunk.ext.param = b.readUint16(), this._chunk.ext.flags & g.CHUNK_EXT_FLAG.EDAT ? (this._chunk.ext.length = this._chunk.ext.param + 1, this._buffers.ext = new WMKS.Packet.createNewPacket(this._chunk.ext.length), this._setReceiveState(g.SESSION_RECEIVE_STATE.EXTENSION_DATA)) : (this._chunk.ext.length = 0, this._setReceiveState(g.SESSION_RECEIVE_STATE.DATA));
                break;
            case g.SESSION_RECEIVE_STATE.EXTENSION_DATA:
                this._buffers.ext = null, this._setReceiveState(g.SESSION_RECEIVE_STATE.DATA);
                break;
            case g.SESSION_RECEIVE_STATE.DATA:
    ...
    {
        var c, d, e;
        return this._checkErrorIsChannel("send", a) ? this._checkErrorChannelState("send", a, g.CHANNEL_STATE.OPEN) ? b instanceof Uint8Array || b instanceof ArrayBuffer ? (c = this._buffers.send, c.reset(), c.writeUint8(a.id), e = b.byteLength, d = g.CHUNK_FLAG.FIN, e > g.CHUNK_MAX_LEN ? (c.writeUint8(g.CHUNK_FLAG.LC | d), c.writeUint16(0), c.writeUint32(e - 1)) : (c.writeUint8(d), c.writeUint16(e - 1)), this.socket.send(c.getData()), this.socket.send(b), !0) : (this._vvcInstance.setLastError(g.STATUS.INVALID_ARGS, "VVCSession.send", "Invalid data, must be Uint8Array or ArrayBuffer"), !1) : !1 : !1
    }, l.prototype._createEvent = function(a, b)
    {
        var c = document.createEvent("Event");
        c.initEvent(a, !1, !1);
        for (var d in b) c[d] = b[d];
        return c
    }, l.prototype._checkErrorIsChannel = function(a, b)
    {
    ...
    }, l.prototype._checkErrorSessionState = function(a, b)
    {
    ...
    }, l.prototype._checkErrorInitialData = function(a, b)
    {
...
function()
{
    ...
    }), WMKS.CoreWMKS = function(a)
    {
        ...
        var h = function(a)
            ...
            {
                $(window)
                    .off("resize.wmks", h), c.wmks[0].style.cssText = c.oldCssText, c.wmksData.rescaleOrResize(!0), $(window)
                    .off("resize.wmks", i), d(WMKS.CONST.Events.FULL_SCREEN_CHANGE, a,
                    {
                        isFullScreen: !1
                    })
            };
        this.fullScreenChangeEventStr = ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"].join(" "), this.fullScreenChangeHandler = function()
            {
                WMKS.UTIL.isFullscreenNow() || ($(window)
                    .off("resize.wmks", i), $(window)
                    .on("resize.wmks", i))
            }, $(document)
            .on(this.fullScreenChangeEventStr, this.fullScreenChangeHandler), WMKS.CoreWMKS.prototype.enterFullScreen = function()
            {
                if (WMKS.UTIL.isFullscreenNow() || !WMKS.UTIL.isFullscreenEnabled()) return;
                this.oldCssText = a[0].style.cssText, console.log("old css is " + this.oldCssText), $(window)
                    .off("resize.wmks", h), $(window)
                    .on("resize.wmks", h), WMKS.UTIL.toggleFullScreen(!0, a[0])
            }, WMKS.CoreWMKS.prototype.exitFullScreen = function()
            {
                if (!WMKS.UTIL.isFullscreenNow()) return;
                $(window)
                    .on("resize.wmks", i), WMKS.UTIL.toggleFullScreen(!1)
            }
    ...
    {
        this.wmksData && (clearTimeout(this.wmksData._vncDecoder.resolutionTimer), this.wmksData.destroy()), $(document)
            .off(this.fullScreenChangeEventStr, this.fullScreenChangeHandler), $(window)
            .off("resize.wmks"), this.wmksData = null, this.wmks = null
