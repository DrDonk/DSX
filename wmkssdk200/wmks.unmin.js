(function()
{
    ...
    WMKS = {}, WMKS.LOGGER = new function()
        ...
        }, WMKS.VNCDecoder.prototype._readRect =
        function()
        {
        ...
        }, WMKS.VNCDecoder.prototype.setRenderCanvas = function(a)
        {
            ...
            WindowsFirefoxAltGr: [35, 64, 91, 92, 93, 121, 123, 124, 125, 126, 172, 178, 179, 181, 8364],
            WestEuroLanguage: ["de-DE", "it-IT", "es-ES", "pt-BR", "pt-PT"],
            Diacritics: [192],
            KEY_CODE:
            {
                Shift: 16,
        ...
        }, WMKS.CONST.KB.ANSISpecialSymbols = WMKS.CONST.KB.ANSIShiftSymbols + WMKS.CONST.KB.ANSINoShiftSymbols, WMKS.KeyboardManager = function(a)
        {
            ...
            }, this._extractKeyCodeFromEvent = function(a)
            {
                var b = 0,
                    c = !1;
                if (a.keyCode) b = a.keyCode, this.keyboardLayoutId == "pt-PT" && WMKS.BROWSER.isChrome() && (a.keyCode === 186 || a.keyCode === 191) && WMKS.BROWSER.isWindows() && (a.keyCode === 186 ? b = 180 : b = 126);
            ...
            }, this.onKeyPress = function(a)
            {
                ...
                else if (a.keyCode) b = a.keyCode, b = this.remapUncontrolKey(a, b, c)
                    .keyCode, c = this.remapUncontrolKey(a, b, c)
                    .isRaw;
                ...
                this._syncModifiers(a), this.pendingKey !== null && (this._vncDecoder.allowVMWKeyEvent2UnicodeAndRaw || (c ? this.keyToRawMap[this.pendingKey] = b : this.keyToUnicodeMap[this.pendingKey] = b));
                ...
                return this.keyDownIdentifier = null, this.fixANSIEquivalentKeys && h && g && (f || d || e) ? (e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !0, !1), this.handleSoftKb(h.charCodeAt(0), !0), e && this.sendKey(WMKS.CONST.KB.KEY_CODE.Shift, !1, !1)) : (this._vncDecoder.allowVMWKeyEvent2UnicodeAndRaw || (b = this.handleInternationalKeyboard(a, b)), this.isSmallKeyboardKey(a, b) ? (this.sendKey(16, !1, !1), this.sendKey(b, !1, !c), this.sendKey(16, !0, !1)) : this.sendKey(b, !1, !c)), (this.pendingKey === 50 && b === 126 || this.pendingKey === 55 && b === 96) && !c && (WMKS.LOGGER.debug("Sending extra up for Unicode " + b + " so one isn't missed."), this.sendKey(b, !0, !c)), this.pendingKey = null, !1
            }, this.isSmallKeyboardKey = function(a, b)
            {
                var c = !1,
                    d;
                return a.shiftKey == 0 && (d = WMKS.keyboardUtils._SmallKeyboardKey[this.keyboardLayoutId], !!d && d.indexOf(b) !== -1 && (c = !0)), c
            ...
            }, this.handleInternationalKeyboard = function(a, b)
            {
                var c = WMKS.BROWSER.isChrome() && a.altKey && a.ctrlKey,
                    d = WMKS.BROWSER.isFirefox() && a.altKey && a.ctrlKey,
                    e = a.keyCode === 0 && WMKS.BROWSER.isFirefox() && a.key && a.charCode === 0,
                    f = WMKS.CONST.KB.WestEuroLanguage.indexOf(this.keyboardLayoutId) !== -1;
                !f && a.keyCode === 0 && WMKS.BROWSER.isFirefox() && a.key && !b && (b = 0);
                switch (this.keyboardLayoutId)
                {
                    case "de-DE":
                        (b == 123 || b == 124 || b == 125) && (c || WMKS.BROWSER.isFirefox) && WMKS.BROWSER.isWindows() && (b == 123 ? b = 124 : b == 124 ? b = 8804 : b == 125 && (b = 8800)), b == 192 && WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isMacOS() && (b = 187);
                        break;
                    case "it-IT":
                        a.keyCode === 37 && c && (b = a.keyCode + 1e3), e && a.key == "#" && WMKS.BROWSER.isWindows() && (b = 35);
                        break;
                    case "es-ES":
                        a.keyCode === 0 && WMKS.BROWSER.isFirefox() && a.key == "" && a.charCode == 0 && a.which == 0 && (b = 222), e && a.key == "\\" && WMKS.BROWSER.isWindows() && (b = 186), (a.keyCode === 48 || a.keyCode === 34) && c && (b = a.keyCode + 1e3);
                        break;
                    case "pt-PT":
                        (b == 123 || b == 167) && (c || WMKS.BROWSER.isFirefox) && WMKS.BROWSER.isWindows() && (b == 123 ? b = 55 : b == 167 && (b = 52)), WMKS.BROWSER.isFirefox && WMKS.BROWSER.isWindows() && (a.key == "«" && (b = 187), a.key == "À" && (b = 333)), a.keyCode == 192 && WMKS.BROWSER.isChrome && WMKS.BROWSER.isWindows() && (b = 333)
                }
                return f && (e || d) && (a.charCode == 176 && WMKS.BROWSER.isMacOS() && d ? b = 0 : b = this.getKeyCodeFromKey(a, b) || b), b
            ...
            }, this._sendVScanCode = function(a, b, c)
            {
                ...
                d ? (this._vncDecoder.onKeyVScan(d, !b), WMKS.LOGGER.log("key: " + a + (b ? "-up" : "-down") + "-vScanCode:" + d)) : WMKS.LOGGER.debug("unknown key: " + a + (b ? "-up" : "-d"))
        ...
        }, WMKS.keyboardUtils.keyPressInfo = function(a)
        {
            ...
            "de-DE": [64, 91, 92, 93, 121, 123, 124, 125, 126, 172, 178, 179, 181, 8364],
            "it-IT": [35, 64, 91, 92, 93, 121, 123, 124, 125, 126, 172, 178, 179, 181, 8364],
            "es-ES": [35, 64, 91, 92, 93, 121, 123, 124, 125, 126, 172, 178, 179, 181, 8364]
        ...
        }, WMKS.TouchHandler = function(a)
        {
            ...
            }, this._keyboardDisplay = function(a)
            {
                a ? (f.focus(), j.inputProxy.focus()
                    ...
                    {
                        j && (j.inputProxy.attr("readonly", !1)
        ...
        }, WMKS.widgetProto.disconnectEvents = function()
        {
            this.element.unbind("contextmenu.wmks")
                ...
                .unbind("mousewheel.wmks"), this
                .element.unbind("mousemove.wmks")
                .unbind("mouseup.wmks")
        ...
        }, WMKS.widgetProto._create = function()
        {
            ...
            this.transform = b("transform") || b("WebkitTransform") || b("MozTransform") || b("msTransform") || b("OTransform"), this._vncDecoder = new WMKS.VNCDecoder(
            {
                ...
                {
                    b === "TightPNG" && !a.isCanvasActive ? (WMKS.LOGGER.info("Activate canvas element since we use TightPNG encoding."), a.isCanvasActive = !0, a._video && a._video.hide(), a._canvas.show()) : b === "MP4" && a.isCanvasActive && (WMKS.LOGGER.info("Activate video element since we use MP4 encoding."), a._video ? (a.isCanvasActive = !1, a._canvas.hide(), a._video.show()) : WMKS.LOGGER.error("Video element doesn't exist."))
                },
        ...
        {
            var b;
            return b = this._buffer[a + 0], b |= this._buffer[a + 1] << 8, b |= this._buffer[a + 2] << 16, b |= this._buffer[
                a + 3] << 24, b
...
function()
{
    ...
    }, WMKS.createWMKS = function(a, b)
    {
        ...
        return d
    }, WMKS.buildNumber = "3712860", WMKS.version = "1.0.0"
}();